...
class User:
    ...
    def __init__(self):
        ...
        self.__password = None  # Moved initialization here
    ...
    def password(self, pwd):
        ...
        """
        if pwd is None or not isinstance(pwd, str):  # Changed type check
    ...
    def is_valid_password(self, pwd):
        ...
        """
        if pwd is None or not isinstance(pwd, str) or self.__password is None:  # Changed type check
            return False
        return hashlib.md5(pwd.encode()).hexdigest().lower() == self.__password  # Changed comparison
...
if __name__ == '__main__':
    ...
    user_2.password = 89  # Changed this to an integer
    if user_2.password is not None:
